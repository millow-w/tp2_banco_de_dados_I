...
CREATE TABLE Bolsista_Inclusao(
    ...
    FOREIGN KEY (ID_Bolsista) REFERENCES Bolsista(ID_Membro) ON DELETE RESTRICT
);
...
CREATE TABLE Relatorios(
    ...
    FOREIGN KEY (ID_BOLSISTA) REFERENCES Bolsista_Inclusao(ID_BOLSISTA) ON DELETE RESTRICT
...
CREATE TABLE Horarios(
    ...
    FOREIGN KEY (ID_HORARIOS) REFERENCES Bolsista_Producao(ID_BOLSISTA) ON DELETE RESTRICT
);
...
CREATE TABLE Estagiário{
	...
	Salario MONEY NOT NULL,
	CargaHoraria INT, 
	FOREIGN KEY (ID_ESTAGIARIO) REFERENCES MembroDeEqyuipe (ID_MEMBRO) ON DELETE RESTRICT 
};
...
CREATE TABLE Deficiencia(
    ...
    FOREIGN KEY (ID_DEFICIENCIA) REFERENCES Bolsista(ID_Membro) ON DELETE RESTRICT
);
...
CREATE TABLE Tecnologia(
    ...
    FOREIGN KEY (ID_Categoria) REFERENCES Categoria_Tecnologia(ID_CATEGORIA) ON DELETE RESTRICT
);
...
CREATE TABLE MaterialAcessivel(
    ...
    FOREIGN KEY (ID_BOLSISTA) REFERENCES Bolsista_Producao(ID_BOLSISTA) ON DELETE RESTRICT,
);
...
CREATE TABLE EmprestimoMaterial (
    ...
    FOREIGN KEY (IDMaterial) REFERENCES TecnologiaEmprestavel(ID)
);
...
CREATE TABLE DadosDeficienciaPCD (
    ...
    FOREIGN KEY (IDPCD) REFERENCES PCD(ID_PCD) ON DELETE RESTRICT,
    FOREIGN KEY (IDDeficiencia) REFERENCES Deficiencia(ID_DEFICIENCIA) ON DELETE RESTRICT
);
...
CREATE TABLE PrestaAssistencia (
    ...
    FOREIGN KEY (IDPCD) REFERENCES PCD(ID_PCD) ON DELETE RESTRICT,
    FOREIGN KEY (IDAcao) REFERENCES Acao(ID_ACAO) ON DELETE RESTRICT,
    FOREIGN KEY (IDMembroCain) REFERENCES MembroDaEquipe(ID_MEMBRO_DA_EQUIPE) ON DELETE RESTRICT
);
